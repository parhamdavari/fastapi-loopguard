...
async def create_charge(
    amount: float, billing_client: helpers.BillingClient = Depends(get_billing)
):
    """Charge the amount and return the receipt."""
    receipt_id = await asyncio.to_thread(billing_client.charge, amount)
